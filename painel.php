...
<body>
                ...
                <hr>
                    ...
                    <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modalPlanilha"><i class="fas fa-pen-alt"></i> Criar e Preencher Planilha</a></li>   
                            </ul>
                        </li>
                        <!-- #Link Dropdown Planilhas -->
    ...
    <div class="modal fade" id="modalPlanilha" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-table"></i> Criar Planilha</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action="cadPlanilha.php" method="GET">
            <div class="modal-body">
                Selecione o evento para qual deseja criar a planilha de presença
                </br>
                </br>
                <label for="nomeVinculo" class="form-label"><i class="fas fa-calendar-alt"></i> Selecione o evento:</label>
                <select class="form-control" name="idEvento" id="">
                    <option value="">Selecione</option>
                    <?php 
                        $sql=$conn->query("SELECT * FROM evento");
                        while($evento = $sql->fetch(PDO::FETCH_ASSOC)){
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
                <button type="submit" class="btn btn-success"><i class="fas fa-clipboard"></i> Criar Planilha para este evento</button>
            </div>
        </form>
        </div>
